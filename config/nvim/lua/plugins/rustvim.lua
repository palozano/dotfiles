...
--   { desc = "Run test under cursor (--nocapture)" })
...
return {
  ...
  -- end,
  -- keys = {
  --   { 'n', '<leader>cc', ':RustTest<CR>',                desc = "Run test under cursor" },
  --   { 'n', '<leader>cn', ':RustTest -- --nocapture<CR>', desc = "Run test under cursor (--nocapture)" },
  -- }
}
